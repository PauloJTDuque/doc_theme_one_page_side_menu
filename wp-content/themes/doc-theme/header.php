      ...
      <div class="container">
        <div class="st-main-header-in">
          <div class="st-main-header-left">
            <a class="st-site-branding" href="index.html"><img src='doc-theme/assets/img/logo.png' alt="Nischinto"></a>
          </div>
          <div class="st-main-header-right">
            <div class="st-nav">

              <!-- // retirado abaixo  st-onepage-nav -->
            ...
            <div class="st-opening-hr">
              <h4 class="st-opening-hr-title">Opening Hours</h4>
              <div class="st-opening-date">Saterday - Thusday</div>
              <div class="st-opening-time">9:00 AM - 6:30 PM</div>
            </div>
          </div>
        </div>
      </div>
