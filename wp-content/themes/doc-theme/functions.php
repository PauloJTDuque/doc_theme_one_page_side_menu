...
function wpdoc_load_scripts(){
    ...
    wp_enqueue_style('wpdoc_flaticon', get_template_directory_uri() . '/assets/css/flaticon.css', array(), 1, 'all');
    
    // Loading JS
    wp_enqueue_script( 'wpdoc_jueryui_js', get_template_directory_uri() . '/assets/js/jQueryUi.js', array(), '1.0', true );
